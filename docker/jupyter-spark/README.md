...
## Описание
Прокидывает в контейнер текущую директорию, в которой находится сам [Dockerfile](./Dockerfile), и все, что в ней находится. Таким образом, можно сложить в директорию рядом датасеты и обращаться к ним из Jupyter Notebook
